...
INSERT INTO `events` (`idtype`, `ename`, `manager`, `mcharge`, `beginhr`, `finishhr`, `day`, `size`) VALUES ( 2,"Tendencias del sector automotriz y la pertinencia del Sector Educativo","Dr. Herminio Baltazar Cisneros ","Coordinador General de las Universidades Tecnológicas y Politécnicas","11:00","12:30",26,100);
...
INSERT INTO `events` (`idtype`, `ename`, `manager`, `mcharge`, `beginhr`, `finishhr`, `day`, `size`) VALUES ( 6,"Diseño de Componentes Automotrices","M.C Juan Carlos Collazo Barrientos","-","16:15","18:00",26,100);
...
INSERT INTO `events` (`idtype`, `ename`, `manager`, `mcharge`, `beginhr`, `finishhr`, `day`, `size`) VALUES ( 1,"El desafío de la excelencia en la cadena de suministro","Frank Nalepa","Exdirector de Calidad de BMW","09:00","11:00",27,100);
...
INSERT INTO `events` (`idtype`, `ename`, `manager`, `mcharge`, `beginhr`, `finishhr`, `day`, `size`) VALUES ( 6,"Un México emprendedor","MDA Juan Camilo Mesa Jaramillo","Rector Universidad Cuahutémoc Aguascalientes","12:45","14:30",27,100);
INSERT INTO `events` (`idtype`, `ename`, `manager`, `mcharge`, `beginhr`, `finishhr`, `day`, `size`) VALUES ( 4,"Modelado en SolidWorks. Etapa Final y Premiación","-","-","16:00","19:00",27,100);
INSERT INTO `events` (`idtype`, `ename`, `manager`, `mcharge`, `beginhr`, `finishhr`, `day`, `size`) VALUES ( 6,"Inventarios estratégicos en la industria automotriz","Álvaro Salinas Figueroa","-","16:00","18:30",27,100);
INSERT INTO `events` (`idtype`, `ename`, `manager`, `mcharge`, `beginhr`, `finishhr`, `day`, `size`) VALUES ( 5,"Es Tiempo de Crear","Ing. Cuitláhuac Pérez Cerros","Director de Maindsteel y Presidente de Grupo MAEN","16:00","18:30",27,100);
