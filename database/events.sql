...
INSERT INTO `events` (`idtype`, `ename`, `manager`, `mcharge`, `beginhr`, `finishhr`, `day`, `size`) VALUES ( 1,"Tendencias de la Industria Automotriz","Ing. Armando Ávila Moreno","Vicepresidente de Manufactura de Nissan Mexicana","10:00","11:00",26,900);
...
INSERT INTO `events` (`idtype`, `ename`, `manager`, `mcharge`, `beginhr`, `finishhr`, `day`, `size`) VALUES ( 5,"","Dr. Eduardo Solis Sánchez","Presidente ejecutivo de AMIA","11:00","12:30",26,1000);
...
INSERT INTO `events` (`idtype`, `ename`, `manager`, `mcharge`, `beginhr`, `finishhr`, `day`, `size`) VALUES ( 7,"Exposición de Proyectos Tecnológicos Orientados al Ramo Automotriz ","-","-","12:00","19:00",26,25);

INSERT INTO `events` (`idtype`, `ename`, `manager`, `mcharge`, `beginhr`, `finishhr`, `day`, `size`) VALUES ( 1,"The challenging, amazing and incredible expedition to Business-Excellence","Frank Nalepa","Exdirector de Calidad de BMW","09:00","12:00",27,1000);
...
INSERT INTO `events` (`idtype`, `ename`, `manager`, `mcharge`, `beginhr`, `finishhr`, `day`, `size`) VALUES ( 5,"La competencia por el talento en la industria automotriz","Ma de Lourdes Quijas Jiménez","Human Resources Director, BMW","11:00","12:30",27,1000);
...
INSERT INTO `events` (`idtype`, `ename`, `manager`, `mcharge`, `beginhr`, `finishhr`, `day`, `size`) VALUES ( 4,"Modelado en SolidWorks. Etapa Final y Premiación","-","-","09:00","12:30",27,25);
